...
\paragraph{Le stime}
\begin{itemize}
  \item Si assume che le stime sulle frequenze siano riferite ad un solo paziente perch\`e la maggior parte delle funzioni possono essere svolte localmente ad esso e nel caso di funzioni collettivizzabili verr\`a esplicitamente segnalato.
